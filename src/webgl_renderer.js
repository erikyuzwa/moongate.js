// initially forked from unicodetiles.js::ut.WebGLRenderer
// https://github.com/tapio/unicodetiles.js/blob/master/unicodetiles/ut.WebGLRenderer.js
...
class WebGLRenderer extends Renderer {
  constructor(view) {
    ...
    this.updateStyle();
    this.canvas.width = (this.view.squarify ? this.th : this.tw) * view.w;
  ...
  buildTexture = () => {
    ...
    let h = this.offscreen.height / (this.th + this.pad)
